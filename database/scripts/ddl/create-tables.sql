...
CREATE TABLE IF NOT EXISTS "CONTATO" (
	"ID_CONTATO" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
...
CREATE TABLE IF NOT EXISTS "TIPO_QUARTO" (
	...
	"NO_TIPO_QUARTO" VARCHAR(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "QUARTO" (
	...
	"IN_DISPONIVEL" INTEGER NOT NULL, -- BOOLEAN 0/1
...
CREATE TABLE IF NOT EXISTS "TIPO_PAGAMENTO" (
	...
	"NO_TIPO_PAGAMENTO" VARCHAR(16) NOT NULL
);

CREATE TABLE IF NOT EXISTS "DATA_HOSPEDAGEM" (
	"ID_DATA_HOSPEDAGEM" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,
...
CREATE TABLE IF NOT EXISTS "HOSPEDAGEM" (
	...
	"ID_DATA_HOSPEDAGEM" INTEGER NOT NULL,
	...
	FOREIGN KEY ("ID_DATA_HOSPEDAGEM") REFERENCES "DATA_HOSPEDAGEM" ("ID_DATA_HOSPEDAGEM"),
